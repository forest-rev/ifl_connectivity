# -*- coding: utf-8 -*-
"""
Created on Sat Sep 28 22:21:10 2019
This script sums flux rasters by zone, saving info to csv
@author: pj276
"""
...
inshp = p1.inshp #'/scratch/pj276/ifl_corridors/gadm/gadm36_0.shp'
shpfile = gpd.read_file(inshp)

# Specify field
field = p1.field #'GID_0'
...
# Year
yearlist = p1.yearlist #['2000', '2013']
...
for k in yearlist:
    ...
    if isinstance(ucode[jai], str) or isinstance(ucode[jai], np.unicode):
        l = ucode[jai]
        lorig = l
        if ' ' in l:
            l = l.replace(' ', '_')
