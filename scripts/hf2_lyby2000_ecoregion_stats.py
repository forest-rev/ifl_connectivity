# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 11:44:38 2020
...
# Break out of script if rock and ice or otherwise unsuitable ecoregion
if ucode[jai] == -9999 or ucode[jai] == -9998:
    print('ecoregions out of scope, exiting')
    sys.exit(0)
...
if cx.shape[0] > 0:
    ...
    if ix.shape[0] >= 1:
        ...
        d = {'region': [i], 'scenario': [j], 'year': [k], 'ucode': [l], 'flux2000': [fluxsum], 'tca2000': [tcareasum], 'tcac2000': [tcareaincorrsum], 'tcloss': [tclosssum], 'tclossc': [tclossincorrsum], 'floss': [flosssum]}
