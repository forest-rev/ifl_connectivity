...
mdir = gdir + '/code/scripts/prepnn1_0_2018_3'
...
runS12 = True # hf2_pp_corridor_expander_alt3
runS13 = False # hf2_get_corridor_unique_id_count
runS14 = False # hf2_sum_level1_corridors
...
if runP1 == True:
    ...
    wdir = 'rp5k130k90m_' + scenario + '_' + region + '_2018_ifl'
    fpre = 'ptnbs_130k'
    #----
    ...
    tcvrt = '/scratch/pj276/ifl_corridors/gfc/gfc1_6/gfc1_6_' + region + '_ss_emt_90m/mos_tc2018.vrt'
    ...
    forfileindex = '/scratch/pj276/ifl_corridors' + emd + '/cs2018' + scenario + 'index.txt'    
...
if runS1 == True:
    ...
    repldict = {"scriptname": "hf2_make_directories", "paramoldname": "param_file", "paramnewname": pbase,
            ...
            "syspathnew": "/home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/"}
    for i in ['af','as','sa']:
        for j in ['neg2', 'neg01', 'pos2']:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_make_directories_{region}_{scenario}.py
    """
...
if runS2 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS3 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_concat_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS4 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_get_line_count_for_ppc2_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS5 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_part2_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
    """
    ttwrite = inspect.cleandoc(ttwrite)
    ...
    for i in ['af','as','sa']:
        for j in ['neg2', 'neg01', 'pos2']:
            wdir = 'rp5k130k90m_' + j + '_' + i + '_2018_ifl'
            odir = '/scratch/pj276/ifl_corridors/' + wdir
...
if runS6 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_part3_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS7 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_part4_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Get number of jobarrays
    # and write into the template and then write to file
...
if runS8 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_ppc4_redo_list_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS9 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_ptnbs_rename_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS10 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_point_pair_create_part5_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS11 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_get_line_count_for_correx_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS12 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_pp_corridor_expander_alt3_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
...
if runS13 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_get_corridor_unique_id_count_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS14 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_sum_level1_corridors_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
...
if runS15 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_clean_up_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS16 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_summarize_corridors_alt_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
...
if runS17 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_stack_corridors_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
...
if runS18 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_mosaic_corridor_tiles_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS19 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_aggregate_rasters_{region}_{scenario}.py
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Write submit script to file
    for i in ['af','as','sa']:
...
if runS20 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_make_convex_hulls_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Get number of jobarrays
    # and write into the template and then write to file
...
if runS21 == True:
    ...
    srun ~/.conda/envs/hifo/bin/python /home/pj276/projects/ifl_corridors/code/scripts/prepnn1_0_2018_3/hf2_get_convex_hull_areas_{region}_{scenario}.py ${SLURM_ARRAY_TASK_ID}
    """
    ttwrite = inspect.cleandoc(ttwrite)
    # Get number of jobarrays
    # and write into the template and then write to file
